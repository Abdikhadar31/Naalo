                                            ...
                                            <span class="status-badge bg-<?php 
                                                echo $payroll['status'] === 'paid' ? 'success' : 
                                                    ($payroll['status'] === 'approved' ? 'info' : 
                                                        ($payroll['status'] === 'cancelled' ? 'danger' : 'warning'));
                                            ?>">
                                                <?php echo $payroll['status'] === 'cancelled' ? 'Cancelled' : ucfirst($payroll['status']); ?>
                                            </span>
                                        </td>
                                        <td>
                                            <div class="action-buttons">
                                                ...
                                                <?php if ($payroll['status'] !== 'paid' && $payroll['status'] !== 'cancelled'): ?>
                                                    ...
                                                    <button class="btn btn-sm btn-danger" onclick="updatePayrollStatus(<?php echo $payroll['payroll_id']; ?>, 'cancelled')">
