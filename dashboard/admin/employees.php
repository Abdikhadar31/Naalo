        ...
        switch ($_POST['action']) {
            case 'add':
                try {
                    ...
                    $stmt = $pdo->prepare("INSERT INTO employees (user_id, first_name, last_name, dept_id, position, hire_date, basic_salary, phone, address, gender) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
                    $stmt->execute([
                        $userId,
                        $_POST['first_name'],
                        $_POST['last_name'],
            ...
            case 'edit':
                try {
                    ...
                    $stmt = $pdo->prepare("UPDATE employees SET first_name = ?, last_name = ?, gender = ?, dept_id = ?, position = ?, hire_date = ?, basic_salary = ?, phone = ?, address = ? WHERE user_id = ?");
                    $stmt->execute([
                        $_POST['first_name'],
                        $_POST['last_name'],
                        $_POST['gender'],
