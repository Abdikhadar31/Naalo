        ...
        switch ($_POST['action']) {
            case 'add':
                try {
                    ...
                    $stmt = $pdo->prepare("INSERT INTO employees (user_id, first_name, last_name, gender, phone, hire_date, basic_salary) VALUES (?, ?, ?, ?, ?, ?, ?)");
                    $stmt->execute([
                        $userId,
                        $_POST['first_name'],
                        $_POST['last_name'],
            ...
            case 'edit':
                try {
                    ...
                    $stmt = $pdo->prepare("UPDATE employees SET first_name = ?, last_name = ?, gender = ?, phone = ?, hire_date = ?, basic_salary = ? WHERE user_id = ?");
                    $stmt->execute([
                        $_POST['first_name'],
                        $_POST['last_name'],
                        $_POST['gender'],
...
try {
    $stmt = $pdo->query("
        SELECT u.user_id, u.username, u.email, u.status,
               e.first_name, e.last_name, e.phone, e.hire_date, e.basic_salary,
                ...
                <form action="" method="POST">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" name="hire_date" max="<?php echo date('Y-m-d'); ?>" required>
                        </div>
                        <div class="mb-3">
            ...
            <div class="modal-content">
                ...
                <form action="" method="POST">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label class="form-label">Hire Date</label>
                            <input type="date" class="form-control" name="hire_date" id="edit_hire_date" max="<?php echo date('Y-m-d'); ?>" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Basic Salary</label>
